...
import static com.hyt.advsmallscreen.global.Url.mac;
...
public class NetworkInfoUtil {
    ...
    public static     HashMap<String, String> getTwoMac(Context context ) {
        ...
        LogUtil.e("getTwoMac",  "EnthenetMa1"+ macAddress1);
        HashMap<String, String> macMap = new HashMap<>();
        WifiManager wifiManager = (WifiManager) context.getSystemService(Context.WIFI_SERVICE);

        if (!wifiManager.isWifiEnabled()) {
            wifiManager.setWifiEnabled(true);
            new SharedUtlis(context, Shared.config).putBoolean(Shared.usrWifiStatue, false);
            try {
                Thread.sleep(2000);
        ...
        String macAddress = wifiManager.getConnectionInfo().getMacAddress();
        LogUtil.e("getTwoMac", " NetWorkName   " + wifiManager.getConnectionInfo().getSSID() + " WIFI Mac  " + macAddress);
        // wifi
        ...
        LogUtil.e("getTwoMac", " NetWorkName   " + " mac Mac  " + macAddress1);
